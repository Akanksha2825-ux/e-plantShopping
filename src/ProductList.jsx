...
function ProductList() {
    ...
    const plantsArray = [
        ...
        },
        {
            ...
            plants: [
                ...
                {
                    name: "Pothos",
                    image: "https://cdn.pixabay.com/photo/2021/04/02/11/15/pothos-6175048_1280.jpg",
                    description: "Thrives in various conditions, perfect for beginners.",
                    cost: "$10"
                },
                {
                    name: "Cast Iron Plant",
                    image: "https://cdn.pixabay.com/photo/2021/04/13/17/30/cast-iron-4169132_1280.jpg",
                    description: "Almost indestructible, ideal for forgetful plant owners.",
                    cost: "$18"
                },
                {
                    name: "Snake Plant",
                    image: "https://cdn.pixabay.com/photo/2021/01/22/06/04/snake-plant-5939187_1280.jpg",
                    description: "Low light and water needs, great air purifier.",
                    cost: "$15"
                },
                {
                    name: "Spider Plant",
                ...
                {
                    name: "Bamboo Palm",
                    image: "https://cdn.pixabay.com/photo/2016/01/13/23/17/palm-1130642_1280.jpg",
                    description: "Prefers low light and is great for indoor air quality.",
                    cost: "$20"
                }
            ]
        }
    ...
    const handleAddToCart = (plant) => {
        ...
        setAddedToCart((prevState) => ({
            ...prevState,
            [plant.name]: true, // Track if the product is added to the cart
        }));
    };
        ...
        <div>
            <div className="navbar" style={styleObj}>
                ...
                <div style={styleObjUl}>
                    <div>
                        <a href="#" onClick={handleCartClick} style={styleA}>Plants</a>
                    </div>
                    <div>
